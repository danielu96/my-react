...
//   return (
//     <>
//     <div style={{textAlign:"center" , paddingTop:"3rem" , fontFamily:"impact" , color:"gray"}}>  <i class="fa fa-coffee fa-3x" aria-hidden="true"></i><h1>Kubki z nadrukiem</h1></div>
...
//   <MDBModalContent>
//   <MDBModalHeader>
//          <MDBModalTitle > <h1 style={{paddingLeft:"1.1rem"}}>{card.title}</h1></MDBModalTitle>  
